...
struct obj_CompositeScene : private simple_py_wrapper<composite_scene<module_store>,composite_scene_obj_base> {
...
#define COMMA_WORKAROUND tproto_base<Var,InPlace>
template<bool Var,bool InPlace> const size_t tproto_base<Var,InPlace>::base_size = n_triangle_prototype::item_offset
...
PyGetSetDef obj_CompositeScene_getset[] = {
    ...
    {"ambient_color",OBJ_GETTER(obj_CompositeScene,self->get_base().ambient),NULL,NULL,NULL},
    {"bg1",OBJ_GETTER(obj_CompositeScene,self->get_base().bg1),NULL,NULL,NULL},
    {"bg2",OBJ_GETTER(obj_CompositeScene,self->get_base().bg2),NULL,NULL,NULL},
    {"bg3",OBJ_GETTER(obj_CompositeScene,self->get_base().bg3),NULL,NULL,NULL},
...
PySequenceMethods obj_CameraAxes_sequence_methods = {
    ...
    .sq_ass_item = [](PyObject *self,Py_ssize_t index,PyObject *value) -> int {
        if(UNLIKELY(!value)) {
...
PyGetSetDef obj_Solid_getset[] = {
    ...
    {"orientation",OBJ_GETTER(obj_Solid,self->orientation),NULL,NULL,NULL},
    {"inv_orientation",OBJ_GETTER(obj_Solid,self->inv_orientation),NULL,NULL,NULL},
    {"position",OBJ_GETTER(obj_Solid,self->position),NULL,NULL,NULL},
...
PyGetSetDef obj_Triangle_getset[] = {
    ...
    {"face_normal",OBJ_GETTER(obj_Triangle,self->face_normal),NULL,NULL,NULL},
    {"edge_normals",reinterpret_cast<getter>(&obj_Triangle_getedges),NULL,NULL,NULL},
    {NULL}
};
...
PyObject *obj_KDLeaf_new(PyTypeObject *type,PyObject *args,PyObject *kwds) {
    ...
    try {
        try {
            ...
            ptr->_data = kd_leaf<module_store>::create(size,[=](size_t i) -> primitive<module_store>* {
                auto p = primitives[i];
...
PyGetSetDef obj_Camera_getset[] = {
    {"origin",OBJ_GETTER(wrapped_type<n_camera>,self->get_base().origin),OBJ_SETTER(wrapped_type<n_camera>,self->get_base().origin),NULL,NULL},
    {"axes",OBJ_GETTER(wrapped_type<n_camera>,reinterpret_cast<PyObject*>(new obj_CameraAxes(self))),NULL,NULL,NULL},
...
PyGetSetDef obj_AABB_getset[] = {
    ...
    {"start",OBJ_GETTER(wrapped_type<n_aabb>,self->get_base().start),NULL,NULL,NULL},
    {"end",OBJ_GETTER(wrapped_type<n_aabb>,self->get_base().end),NULL,NULL,NULL},
    {NULL}
};
...
PyGetSetDef obj_TrianglePrototype_getset[] = {
    ...
    {"face_normal",OBJ_GETTER(obj_TrianglePrototype,self->get_base().pt()->face_normal),NULL,NULL,NULL},
...
PyGetSetDef obj_TrianglePointDatum_getset[] = {
    {"point",OBJ_GETTER(wrapped_type<n_detached_triangle_point>,self->get_base().point),NULL,NULL,NULL},
    {"edge_normal",OBJ_GETTER(wrapped_type<n_detached_triangle_point>,self->get_base().edge_normal),NULL,NULL,NULL},
    {NULL}
};

PyTypeObject detached_triangle_point_obj_base::_pytype = {
    PyVarObject_HEAD_INIT(nullptr,0)
    .tp_name = FULL_MODULE_STR ".TrianglePointDatum",
    .tp_basicsize = sizeof(wrapped_type<n_detached_triangle_point>),
...
PyGetSetDef obj_SolidPrototype_getset[] = {
    ...
    {"orientation",OBJ_GETTER(wrapped_type<n_solid_prototype>,self->get_base().ps()->orientation),NULL,NULL,NULL},
    {"inv_orientation",OBJ_GETTER(wrapped_type<n_solid_prototype>,self->get_base().ps()->inv_orientation),NULL,NULL,NULL},
    {"position",OBJ_GETTER(wrapped_type<n_solid_prototype>,self->get_base().ps()->position),NULL,NULL,NULL},
...
PyGetSetDef obj_PointLight_getset[] = {
    {"position",OBJ_GETTER(wrapped_type<n_point_light>,self->get_base().position),NULL,NULL,NULL},
    {"color",OBJ_GETTER(wrapped_type<n_point_light>,self->get_base().c),NULL,NULL,NULL},
...
PyGetSetDef obj_GlobalLight_getset[] = {
    {"direction",OBJ_GETTER(wrapped_type<n_global_light>,self->get_base().direction),NULL,NULL,NULL},
    {"color",OBJ_GETTER(wrapped_type<n_global_light>,self->get_base().c),NULL,NULL,NULL},
...
std::tuple<n_aabb,kd_node<module_store>*> build_kdtree(const char *func,PyObject *args,PyObject *kwds) {
    auto [primitives_obj,extra_threads] = get_arg::get_args(func,args,kwds,
        param("primitives"),
        param<int>("extra_threads",-1));

    auto p_objs = collect<py::object>(primitives_obj);
    ...
    {
        py::allow_threads _;
        return build_kdtree<module_store>(primitives,extra_threads);
    }
}
...
PyObject *obj_build_composite_scene(PyObject*,PyObject *args,PyObject *kwds) {
    try {
        ...
        return reinterpret_cast<PyObject*>(new obj_CompositeScene(boundary,root));
    } PY_EXCEPT_HANDLERS(nullptr)
}
...
extern "C" SHARED(PyObject) * APPEND_MODULE_NAME(PyInit_)() {
    ...
    for(auto cls : classes) {
        if(UNLIKELY(PyType_Ready(cls) < 0)) return NULL;
    }
