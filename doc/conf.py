# -*- coding: utf-8 -*-
#
# NTracer documentation build configuration file, created by
...
project = u'NTracer'
copyright = u'2013, Rouslan Korneychuk'
...
try:
    _v = subprocess.check_output(['git','describe','--long','--dirty'])
except:
    pass
else:
    # calling str here is needed for Python 3 and harmless in Python 2
    _v = str(_v).strip().split('-')
    del _v[2] # get rid of the revision hash
